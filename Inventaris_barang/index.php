                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                    $ambildatastock = mysqli_query($conn, "select * from barang b, satuan s where b.idsatuan = s.idsatuan ");
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
                                ...
                                <div class="modal fade" id="myModal">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <br>
                                        <input type="number" name = "total" placeholder="stock" class="form-control" required>
                                        <br>
                                        <input type="text" name = "harga" placeholder="Harga" class="form-control" required>
                                        <br>
                                        <button type="submit" class="btn btn-primary" name="addbarang">Tambahkan</button>
                                    </div>
</form>
